...
switchButton.addEventListener("click", () => {
  const tempValue = firstInput.value; // Store the value of the first input
  firstInput.value = secondInput.value; // Set the first input to the value of the second input
  secondInput.value = tempValue; // Set the second input to the temporary value stored earlier
});
